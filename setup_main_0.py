...
if place_id_1 is None or place_id_1 == "":
    print("FAIL: Can't create Place")
place_id_2 = exec_command(my_console, "create Place city_id=\"{}\" user_id=\"{}\" name=\"House1\" description=\"des\" number_rooms=1 number_bathrooms=1 max_guest=2 price_by_night=90 latitude=1.3 longitude=2.3".format(city_id_0_0, user_id_0))
if place_id_2 is None or place_id_2 == "":
    print("FAIL: Can't create Place")
place_id_3 = exec_command(my_console, "create Place city_id=\"{}\" user_id=\"{}\" name=\"House1\" description=\"des\" number_rooms=1 number_bathrooms=1 max_guest=2 price_by_night=90 latitude=1.3 longitude=2.3".format(city_id_0_1, user_id_0))
if place_id_3 is None or place_id_3 == "":
    print("FAIL: Can't create Place")
place_id_4 = exec_command(my_console, "create Place city_id=\"{}\" user_id=\"{}\" name=\"House1\" description=\"des\" number_rooms=1 number_bathrooms=1 max_guest=2 price_by_night=90 latitude=1.3 longitude=2.3".format(city_id_0_1, user_id_0))
if place_id_4 is None or place_id_4 == "":
    print("FAIL: Can't create Place")
place_id_5 = exec_command(my_console, "create Place city_id=\"{}\" user_id=\"{}\" name=\"House1\" description=\"des\" number_rooms=1 number_bathrooms=1 max_guest=2 price_by_night=90 latitude=1.3 longitude=2.3".format(city_id_0_2, user_id_0))
if place_id_5 is None or place_id_5 == "":
    print("FAIL: Can't create Place")
place_id_6 = exec_command(my_console, "create Place city_id=\"{}\" user_id=\"{}\" name=\"House1\" description=\"des\" number_rooms=1 number_bathrooms=1 max_guest=2 price_by_night=90 latitude=1.3 longitude=2.3".format(city_id_1_0, user_id_0))
if place_id_6 is None or place_id_6 == "":
    print("FAIL: Can't create Place")
place_id_7 = exec_command(my_console, "create Place city_id=\"{}\" user_id=\"{}\" name=\"House1\" description=\"des\" number_rooms=1 number_bathrooms=1 max_guest=2 price_by_night=90 latitude=1.3 longitude=2.3".format(city_id_1_0, user_id_0))
if place_id_7 is None or place_id_7 == "":
    print("FAIL: Can't create Place")
place_id_8 = exec_command(my_console, "create Place city_id=\"{}\" user_id=\"{}\" name=\"House1\" description=\"des\" number_rooms=1 number_bathrooms=1 max_guest=2 price_by_night=90 latitude=1.3 longitude=2.3".format(city_id_1_0, user_id_0))
if place_id_8 is None or place_id_8 == "":
    print("FAIL: Can't create Place")
place_id_9 = exec_command(my_console, "create Place city_id=\"{}\" user_id=\"{}\" name=\"House1\" description=\"des\" number_rooms=1 number_bathrooms=1 max_guest=2 price_by_night=90 latitude=1.3 longitude=2.3".format(city_id_1_0, user_id_0))
